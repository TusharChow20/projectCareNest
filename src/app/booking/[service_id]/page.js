...
export default function BookingPage() {
  ...
  const handleSubmit = async () => {
    ...
    console.log("=== NEW BOOKING PAGE VERSION ===");
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-8 flex justify-between">
            ...
            {step < 3 ? (
              <button
                onClick={handleNext}
                className="ml-auto px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all"
              >
                Next
              </button>
            ) : (
              <button
                ...
                disabled={submitting}
                className="ml-auto px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
