...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: '📧',
      title: 'Email Address',
      details: ['support@carenest.com', 'info@carenest.com', 'Response within 24hrs']
    },
    {
      icon: '⏰',
      title: 'Working Hours',
      details: ['24/7 Emergency Support', 'Office: 9AM - 6PM', 'Saturday - Thursday']
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="relative py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500 text-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Quick FAQs</h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">How quickly can I get a caregiver?</h4>
                    <p className="text-gray-600 text-sm">Usually within 24-48 hours for standard bookings. Emergency services available same-day.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Are your caregivers certified?</h4>
                    <p className="text-gray-600 text-sm">Yes, all caregivers are background-checked, trained, and certified in their specialties.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Can I cancel a booking?</h4>
                    <p className="text-gray-600 text-sm">Yes, you can cancel pending bookings anytime before service starts.</p>
                  </div>
                </div>
              </div>
