...
export default function BookingPage() {
  ...
  const validateStep2 = () => {
    ...
    if (!bookingData.fullAddress.trim())
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">
                    Number of{" "}
                    {bookingData.durationType === "hours" ? "Hours" : "Days"}
                  </label>
                  <input
                    type="number"
                    name="duration"
                ...
                <div className="p-6  rounded-lg">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-gray-200">Service Rate:</span>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-600 ${
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 border rounded-lg disabled:bg-gray-100 text-gray-600 ${
                      errors.district ? "border-red-500" : "border-gray-300"
                    }`}
                  >
                    <option value="">Select District</option>
                    {bookingData.division &&
                      districts[bookingData.division]?.map((dist) => (
                ...
                <div>
                  ...
                  >
                    ...
                    {bookingData.district &&
                      cities[bookingData.district]?.map((city) => (
                ...
                <div>
                  ...
                  >
                    ...
                    {bookingData.city &&
                      areas[bookingData.city]?.map((area) => (
          ...
          <div className="mt-8 flex justify-between">
            {step > 1 && (
              <button
                ...
                className="px-6 py-3 border-2 border-gray-300 cursor-pointer rounded-lg font-semibold hover:bg-gray-700"
              >
                Previous
              </button>
            )}
            ...
            {step < 3 ? (
              <button
                onClick={handleNext}
                className="ml-auto px-6 py-3 border text-white cursor-pointer rounded-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all"
              >
                Next
              </button>
            ) : (
              <button
                ...
                disabled={submitting}
                className="ml-auto px-8 py-3 border cursor-pointer text-white rounded-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
